...
var argv = require('yargs').argv; // The contemporary library of choice for
									// parsing command arguments (in this case
									// flags)
  ...
  return new Promise((resolve, reject) => { // eslint-disable-line
    ...
    del([buildDirectory])
      .then(() => {
    	...
    	var appVersion = argv.appVersion ? argv.appVersion : 'dev-build';
        ...
        let sourcesStream = polymerProject.sources()
          ...
          // replace version
          .pipe(gulpif(/index\.html$/, replace('@@appVersion', appVersion)))
          ...
          // to rejoin those files with the `.rejoin()` method when you're
			// done.
          .pipe(sourcesStreamSplitter.split())

          // Uncomment these lines to add a few more example optimizations to
			// your
          // source files, but these are not included by default. For
			// installation, see
